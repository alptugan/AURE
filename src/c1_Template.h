...
class c1_Template : public BaseContent {
...
public:
	...
	~c1_Template() {}
	void onPar1() override { setSize(); }
	void onPar2() override { setParameter2(true); }
	void onPar3() override { setParameter3(true); }
	void onPar4() override { setParameter4(); }
	void onPar5() override { setParameter5(); }
