...
class c2_SuperShape : public BaseContent {
...
public:
	...
	~c2_SuperShape() {}
	void onPar1() override { iterationBtnHandler(); }
	void onPar2() override { setm1(); }
	void onPar3() override { setm2(); }
	void onPar4() override { setRandomColor(); }
	void onPar5() override { setRandomRadius(); }
	void onReset() override { setRadius(350); }
